...
After opening the app, you will typically follow the work flow below. In short, you will load and save input data, tweak input choices and content, and then copy the resulting email template.
...
First, you will need to create and save an empty excel file as a *.csv file. When you open the app, you should be able to see a side panel which contains some default topics to choose from. At the top of the side panel you should be able to paste the path to your excel file in the field box titled 'Inputs Location'.
...
The first input you can select from is the 'Choose opening line' input field. The opening of your email introduces the response type of the email.There are four default topics to choose from.  For instance, you would pick the opening line 'reply' if you are responding to a reply of the recipient in question (see picture of the default choices below).
...
If you cannot find what you are looking for, you can enter a new choice of opening line in the text input field. You can add it to the default choices by clicking the 'Add to choices..' button (see a picture of the input field and button below). .
...
The second input you can choose from is titled 'Choose topic'. This input field refers to the overall topic of your email. In essence, it will set the topic for the main body of your template. The body of an email normally elaborates on the purpose of the email and contains detailed information. Again, there are four default choices (see picture below). 
...
The third and forth inputs you can choose from are titled 'Choose day of week' and 'Choose time of day' respectively. You can select the present day of the week and time of the day. Doing so will compose a day and time appropriate greeting line (see pictures below). 
...
The final inputs to edit are titled 'Closing Line' and 'Insert your Name' respectively. You can sign off your email with a closing line and and seal it with your name. The popular sign off 'kind regards,..' is set as a default, but feel free to insert a different closing line.
...
Importantly, the excel file cannot be open while saving or loading inputs. If the excel file open during the export-import processing, the following error will show:
...
Once again, you will need to create and save an empty excel file to be able to load and save your input for later usage of the application. Once you have done that, you will need to paste the path to your excel file in the Inputs Location field at the top of the Content Editor tab (see picture below).
...
Once you have customized or loaded your content from previous sessions, you can proceed to the Template tab. Here you can view what the complete email template looks like. If you are satisfied with the result, you can copy it and insert it to your email draft. An example template is displayed in the picture below.
